...
public class RequestJobIT extends AbstractIT {
	...
	/**
	 * Invoke PORT.requestJob on an invalid (empty string) origin.
	 * 
	...
	/**
	 * Invoke PORT.requestJob on an invalid (null) origin.
	 * 
	 * @result Should throw BadLocationFault_Exception as the origin is invalid.
	 * @throws Exception
	 */
	...
	/**
	 * Invoke PORT.requestJob on an invalid (empty string) destination.
	 * 
	...
	/**
	 * Invoke PORT.requestJob on an invalid (null) destination.
	 * 
	 * @result Should throw BadLocationFault_Exception as the destination is
	 *         invalid.
	 * @throws Exception
	...
	/**
	 * Invoke PORT.requestJob on both invalid (empty string) origin and
	 * destination.
	 * 
	...
	/**
	 * Invoke PORT.requestJob on both invalid (null) origin and destination.
	 * 
	 * @result Should throw BadLocationFault_Exception as both the origin and
	 *         the destination is invalid.
	 * @throws Exception
	...
	/**
	 * Invoke PORT.requestJob with an invalid (negative) price.
	 * 
	...
	/**
	 * Invoke PORT.requestJob with all invalid parameters (empty string
	...
	/**
	 * Invoke PORT.requestJob with all invalid parameters (null locations and
